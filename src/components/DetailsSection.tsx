    ...
    <section id="details" className="w-full bg-black py-16">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2 items-stretch">
          ...
          <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl h-full flex flex-col">
            {/* Header with gradient and background image */}
            <div className="relative h-24 sm:h-32 p-6 sm:p-8 flex flex-col justify-center">
              {/* Background image */}
              <div 
              ...
              {/* <div className="relative z-10">
                <div className="inline-block px-4 sm:px-6 py-2 border border-black/30 text-black rounded-full text-xs backdrop-blur-sm bg-white/80">
                  Product Details
                </div>
              </div> */}
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-black drop-shadow-lg">
            ...
            {/* Specifications */}
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 sm:p-8 text-white flex-1">
            ...
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 sm:p-8 text-white flex-1">
              <form onSubmit={handleSubmit} className="space-y-4 h-full flex flex-col">
                ...
                <div className="mt-auto">
                  <button 
                    type="submit" 
                    className="w-full px-6 py-4 bg-black text-white rounded-xl font-semibold hover:bg-gray-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-lg"
                  >
                    Send Message
                  </button>
                </div>
